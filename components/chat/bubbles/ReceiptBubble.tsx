/**
 * Receipt (Recibo de Caja / Recibo de Pago) message bubble component.
 */
      ...
      <div className="flex justify-between items-center border-b border-emerald-100 pb-2 mb-2 pr-16">
        <div>
          <span className="font-bold text-emerald-600 text-[10px] uppercase">
            {contactRole === 'supplier' ? 'Recibo de Pago' : 'Recibo de Caja'}
          </span>
      ...
      <div className="text-center mb-2">
        ...
        {contactRole === 'supplier' && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-2 mb-2 text-[10px] text-blue-700">
            <div className="font-bold mb-1">Recibido de: {meta.clientName || contactName}</div>
            {meta.paymentMethod && <div>Método: {meta.paymentMethod}</div>}
          </div>
        )}
